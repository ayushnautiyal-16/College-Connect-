        ...
        <div className="bg-gray-50 min-h-screen font-sans selection:bg-indigo-100 selection:text-indigo-900">
            ...
            <section className="relative pt-32 pb-24 lg:pt-40 lg:pb-32 overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    <img
                        src={getAssetUrl("header-image-1_ccchxr.jpg")}
                        alt="Knowledge Hub Background"
                        className="w-full h-full object-cover object-center"
                    />
                    {/* Heavy Overlay forText Readability */}
                ...
                <div className="container mx-auto px-4 md:px-6 relative z-10 text-center">
                    <AnimatedSection animationType="fade-up" delay={0}>
                        <span className="inline-block py-1.5 px-4 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white text-sm font-semibold mb-8 tracking-wide shadow-lg">
                            OUR LATEST INSIGHTS
                        </span>
                    </AnimatedSection>
                    ...
                    <AnimatedSection animationType="slide-right" delay={200}>
                        <p className="text-lg md:text-xl text-gray-200 max-w-2xl mx-auto leading-relaxed drop-shadow-md font-medium">
            ...
            <div className="container mx-auto px-4 md:px-6 py-12 lg:py-16">
                ...
                {blogPosts.length > 0 && (
                    <AnimatedSection animationType="zoom-in" delay={400} className="mb-16">
                        <div className="group relative rounded-3xl overflow-hidden shadow-2xl bg-white grid grid-cols-1 lg:grid-cols-2 min-h-[400px] border border-gray-100 transition-all duration-500 hover:shadow-[0_20px_50px_rgba(8,_112,_184,_0.14)]">
                            ...
                            <div className="p-8 md:p-12 flex flex-col justify-center">
                                ...
                                <div className="flex items-center justify-between mt-auto">
                                    ...
                                    <button onClick={() => router.push(`/blog/${blogPosts[0].id}`)} className="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center group-hover:bg-indigo-600 group-hover:border-indigo-600 transition-all duration-300">
                ...
                {/* Newsletter Section */}
                <AnimatedSection animationType="zoom-in" delay={300} className="relative overflow-hidden rounded-3xl bg-gray-900 text-white">
                    <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10"></div>
