        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50">
                <div className="text-center">
                    ...
                    <button onClick={() => router.push('/')} className="text-indigo-600 font-medium hover:underline">Back to Home</button>
                </div>
            </div>
        );
    }
    ...
    const getSlideshowImages = (collegeId) => {
        ...
        const imageMap = {
            ...
            7: [
                ...
                getAssetUrl('slider-1_jagmt4.jpg'),
                getAssetUrl('slider-5_us5lez.jpg'),
                getAssetUrl('sddefault_oe0ias.webp')
            ],
            8: [
                getAssetUrl('3-0x0_ktdjzr.jpg'),
                getAssetUrl('img-slide-2_gwrz2i.jpg'),
                getAssetUrl('1-0x0_wolccq.jpg'),
                getAssetUrl('2-0x0_ospmps.jpg'),
                getAssetUrl('img-slide-3_m1nflh.jpg'),
            ],
            9: [
                getAssetUrl('Copy-of-Untitled-1_a3cfou.png'), // Placeholder, user will likely provide specific slider images later.
                getAssetUrl('4-1_q8sqd2.png'),
                getAssetUrl('Untitled-design-100_ncsqlb.png'),
                getAssetUrl('dd-college1_kujwjv.jpg')
                // Generic backup
            ],
            10: [
                getAssetUrl('sbsu_gallery_0097_q8g1mb.jpg'), // Placeholder
                getAssetUrl('sbsu_gallery_0133_g97bky.jpg'),
                getAssetUrl('sbsu_gallery_0092_fir2rb.jpg'),
                getAssetUrl('sbsu_gallery_0096_gbelvc.jpg')
            ],
            11: [
